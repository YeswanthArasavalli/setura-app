...
export default function Admin({ user }) {
  ...
  // 4. Update Token Logic (Optimistic UI Update)
  async function setCurrent(token) {
    if (!hospital) return;

    // Optimistic Update: Server ki velle mundhe UI lo change chesedham
    ...
    if (error) {
      // Failed aithe old state ki vellipovali
  ...
  if (loading) return (
    <div style={{ textAlign: "center", marginTop: "100px", fontFamily: "sans-serif" }}>
      <h2 style={{ color: "#2563eb", animation: "pulse 1.5s infinite" }}>🏥 SETURA Admin</h2>
          ...
          {bookings.map((b) => {
            ...
            return (
              <div key={b.id} style={{
                ...
                <div style={{ margin: "12px 0", fontSize: "14px", color: "#475569", display: "flex", flexWrap: "wrap", gap: "10px", alignItems: "center" }}>
                ...
                {!isCompleted && !isServing && (
                  <button
                    ...
                    style={{
                      ...
                      fontSize: "14px", transition: "transform 0.1s", active: { transform: "scale(0.98)" }
                    }}
                  >
                    CALL PATIENT NEXT
                  </button>
                ...
                {isServing && (
                  <div style={{ textAlign: "center", color: "#15803d", fontWeight: "800", padding: "10px", backgroundColor: "#dcfce7", borderRadius: "10px", fontSize: "13px", letterSpacing: "1px" }}>
