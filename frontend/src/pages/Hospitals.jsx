...
export default function Hospitals() {
  ...
  const t = {
    ...
    te: {
      ...
      yourToken: "మీ టోకెన్", wa: "వాట్సాప్ ద్వారా పంపండి ✅", waPreview: "మెసేజ్ ప్రివ్యూ:"
    },
    hi: {
  ...
  // Memoized fetch function for Vercel stability
          ...
          <div key={h.id} style={{ 
            ...
            {myToken && selectedHospital?.id === h.id ? (
              <div style={{ marginTop: "15px", padding: "15px", backgroundColor: "#eff6ff", borderRadius: "12px", textAlign: "center", border: "1px solid #bfdbfe" }}>
                ...
                {/* Message Preview Logic Integrated */}
                <div style={{ textAlign: "left", fontSize: "12px", backgroundColor: "#fff", padding: "10px", borderRadius: "8px", border: "1px solid #bfdbfe", marginTop: "10px", marginBottom: "10px" }}>
                  <p style={{ margin: "0 0 5px 0", fontWeight: "bold", color: "#64748b" }}>{t[language].waPreview}</p>
                  <pre style={{ margin: 0, whiteSpace: "pre-wrap", color: "#1e293b", fontFamily: "inherit" }}>
                    {decodeURIComponent(getWAMessage())}
                  </pre>
                </div>

                <a href={`https://wa.me/91${phone}?text=${getWAMessage()}`} target="_blank" rel="noreferrer" style={{ textDecoration: "none" }}>
                  <button style={{ width: "100%", padding: "14px", backgroundColor: "#25D366", color: "#fff", border: "none", borderRadius: "10px", fontWeight: "bold", cursor: "pointer", fontSize: "16px" }}>
                    {t[language].wa}
                  </button>
                </a>
              </div>
